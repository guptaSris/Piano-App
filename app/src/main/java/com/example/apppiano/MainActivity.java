...
private HorizontalScrollView scrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Method for all PianoKey Labels TextViews
...
// Initialize the Record button,Play Button and navigation button
        ...
        left_navigation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scrollView.scrollTo((int) scrollView.getScrollX() - 100, (int) scrollView.getScrollX());
            }
        });
        ...
        right_navigation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scrollView.scrollTo((int) scrollView.getScrollX() + 100, (int) scrollView.getScrollY());
            }
        });
